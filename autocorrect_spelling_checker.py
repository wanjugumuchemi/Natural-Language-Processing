# -*- coding: utf-8 -*-
"""Autocorrect spelling checker.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1XRnGk62H70Hc-aLmNzCZfkDFNvFHk_mS
"""
...
bigtxt = nltk.corpus.gutenberg.words('austen-emma.txt')
...
print(replace("support"))

def insert(word):
  letters = string.ascii_lowercase
  return [l + c + r for l, r in split(word) for c in letters]

print(insert("support"))
